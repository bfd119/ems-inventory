        ...
        function cacheElements() {
            ...
            el.viewModeDetail = $('view-mode-detail');
            el.viewModeSummary = $('view-mode-summary');
        ...
        function bindEvents() {
            ...
            if (el.viewModeDetail) {
                el.viewModeDetail.onclick = () => {
                    el.viewModeDetail.classList.add('active');
                    el.viewModeSummary.classList.remove('active');
                    el.combinedListView.style.display = 'block';
                    el.combinedSummaryView.style.display = 'none';
                };
            }
            if (el.viewModeSummary) {
                el.viewModeSummary.onclick = () => {
                    el.viewModeSummary.classList.add('active');
                    el.viewModeDetail.classList.remove('active');
                    el.combinedListView.style.display = 'none';
                    el.combinedSummaryView.style.display = 'flex';
                };
            }
